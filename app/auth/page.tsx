...
import { signInWithGoogle, signInWithFacebook, isFirebaseConfigured } from "@/lib/firebase"
            ...
            {firebaseConfigured && (
              <>
                ...
                <Button
                  ...
                  disabled={isLoading}
                  className="w-full bg-[#1877F2] hover:bg-[#166FE5] text-white border-0 card-3d"
                  size="lg"
                >
                  {loadingProvider === "facebook" ? (
                    ...
                    <div className="flex items-center space-x-2">
                      <svg className="w-5 h-5" role="img" viewBox="0 0 24 24" fill="currentColor">
